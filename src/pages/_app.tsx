...
const MyApp: AppType<{ session: Session | null }> = ({
  ...
  return (
    <SessionProvider session={session}>
      <main className={`${balooChettan2.variable} ${samarkan.variable} ${tourney.variable} font-sans  max-w-screen-2xl mx-auto text-white selection:bg-secondary-200 selection:text-white`}>
