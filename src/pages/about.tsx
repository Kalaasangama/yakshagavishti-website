...
const Index = () => {
  ...
  return (
    <>
        ...
        <div className="container m-auto px-6 md:px-12 xl:px-6">
          <div className="space-y-6 md:flex md:gap-6 md:space-y-0 lg:items-center lg:gap-12">
            ...
            <div className="sm:mx-4 md:w-6/12 lg:mx-0 lg:w-6/12">
              <Reveal classes="">
                <h2
                  className="font-hindi inline-block border-b border-[#D9A15C] text-xl font-bold sm:text-4xl md:text-4xl 2xl:text-5xl"
                >
                  About NMAMIT
                </h2>
              </Reveal>
              <Reveal classes="">
                <p className="text-xs sm:text-sm md:text-base lg:text-base xl:text-lg mt-6 text-justify">
                  Nitte Mahalinga Adyantaya Memorial Institute of
                  Technology(NMAMIT), Nitte, established in 1986 and recognized by
                  the All India Council for Technical Education, New Delhi, has
                  been a constituent college of Nitte (Deemed to be University),
                  Mangaluru, since June 2022.
                </p>
              </Reveal>
              <Reveal classes="">
                <p className="text-xs sm:text-sm md:text-base lg:text-base xl:text-lg mt-4 text-justify">
                  ...
                  Survey of Industry-Linked Technical Institutes 2020. NMAMIT, the
                  off-campus centre of Nitte DU located at Nitte Village, has
                  active collaborations with several international universities
                  and organizations for faculty and student exchanges, research,
                  internships, and placements. (For details, visit
      ...
      <div className="m-10 py-6">
        <div className="container m-auto px-6 md:px-12 xl:px-6">
          <div className="space-y-6 flex flex-col items-center md:flex-row md:gap-6 md:space-y-0 lg:items-center lg:gap-12">
            <Reveal classes="lg:mx-15 mx-0 md:w-5/12 lg:w-5/12">
              <img
                src="/1.png"
                alt="image"
      ...
      <div>
        <div className="font-hindi text-xl sm:text-4xl md:text-4xl 2xl:text-5xl flex items-center justify-center px-6 pt-4 mb-16 font-bold">
          <Reveal classes="">
