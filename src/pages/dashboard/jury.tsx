	...
	return !isLoading && data !== undefined && data.length > 0 ? (
		<div className="container flex w-full flex-col">
			...
			{teamName !== "Select a college" && !scored && ready ? (
				...
				<div className="container py-40">
					<div className="h-full w-full">
						<div className="flex justify-center text-center text-2xl ">
							Thank you for Judging... you can select any other
							team
						</div>
					</div>
				</div>
				...
				<>
					<div className="m-4 flex justify-center p-4 text-center text-2xl">
		...
		<div className="container py-40">
			<div className="h-full w-full">
				<div className="flex justify-center text-center text-2xl ">
					{isLoading
						? "Loading..."
						: "No teams to judge at the moment...."}
				</div>
			</div>
		</div>
	);
